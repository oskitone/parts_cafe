...
SPEAKER_PLATE_HOLE_XY = 3.85;
SPEAKER_PLATE_HEIGHT = .4;
SPEAKER_RIM_DEPTH = 3.8;
SPEAKER_RIM_HEIGHT = 2.8 - SPEAKER_PLATE_HEIGHT;
SPEAKER_CONE_DIAMETER = 30;
SPEAKER_MAGNET_DIAMETER = 18;
SPEAKER_MAGNET_HEIGHT = 5.5;
