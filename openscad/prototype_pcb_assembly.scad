...
include <battery_holder_fixtures.scad>;
include <support_bar.scad>;
include <keys.scad>;
include <pcb_base.scad>;
include <pcb.scad>;
include <speaker-AZ40R.scad>;

module prototype_pcb_assembly(
